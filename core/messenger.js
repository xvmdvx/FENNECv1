...
['openTab', 'openOrReuseTab', 'openActiveTab', 'openTabs', 'replaceTabs', 'closeOtherTabs', 'refocusTab', 'closeTab', 'focusDnaTab', 'getCurrentTabId', 'queryTabs', 'getTab', 'closeTabsByUrlPatterns', 'closeTabsByTitles', 'closeTabsByIds'].forEach(name => {
